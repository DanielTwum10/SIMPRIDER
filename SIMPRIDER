...
/* SIMPLE RIDE — Developer Dashboard: deep black base, electric blue accent, neutral grays */
:root {
  ...
  --brand-blue-dim: oklch(0.6 0.2 250 / 0.15);
  --brand-teal: oklch(0.65 0.15 185);
  --brand-teal-dim: oklch(0.65 0.15 185 / 0.15);
  --status-green: oklch(0.65 0.17 145);
  --status-amber: oklch(0.75 0.17 85);
  --status-red: oklch(0.55 0.22 27);
  --code-bg: oklch(0.13 0 0);
}
